/*Nama File	    : CountingSortAsc.c*/
/*Deskripsi	    : Mengurut tabel integer [1..N] secara menaik dengan counting sort*/
...
/*Algoritma*/
    printf("====================================\n");
    printf("=  Counting Sort Ascending Order   =");
    printf("\n====================================\n\n");
